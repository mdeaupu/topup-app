...
const FreeFire: NextPage = () => {
  ...
  const diamondOptions = [
    { amount: 3, price: "Rp 500" },
    { amount: 5, price: "Rp 901" },
    { amount: 12, price: "Rp 1.802" },
    { amount: 19, price: "Rp 7.207" },
    { amount: 28, price: "Rp 9.009" },
    { amount: 44, price: "Rp 18.008" },
    { amount: 59, price: "Rp 45.005" },
    { amount: 85, price: "Rp  90.009" },
  ];
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-[#4578a7] border-4 border-black rounded-lg p-6 max-w-md w-full">
            ...
            <div className="space-y-3 mb-6">
              ...
              <div className="flex justify-between">
                <span className="text-white">Jumlah Diamond:</span>
